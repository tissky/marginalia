...
const en = {
  ...
  activity: {
    ...
    recentSummary: (
      ...
      cachePct: number,
      llmCalls: number,
    ) => `last ${count} · ${duration} · in ${tokensIn} / out ${tokensOut} · ${cachePct}% cache · ${llmCalls} llm calls`,
    inFlight: "In flight",
    recent: "Recent",
...
const zh: I18nStrings = {
  ...
  activity: {
    ...
    recentSummary: (
      ...
      cachePct: number,
      llmCalls: number,
    ) => `最近 ${count} 个 · ${duration} · 输入 ${tokensIn} / 输出 ${tokensOut} · 缓存 ${cachePct}% · ${llmCalls} 次 LLM`,
    inFlight: "进行中",
    recent: "最近完成",
    noTasks: "暂无任务。",
